...
This is my use-case study(demo/example/sample/tutorial) for that <a title="Thanks a lot for this product"  href="https://jstool.gitlab.io/demo/sheetjs-xlsx-js/">SheetJS-example(thank you!)</a><br/>
